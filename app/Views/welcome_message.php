...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to pustaka 10 <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> CodeIgniter Foundation 4. CodeIgniter is open source project released under the MIT
